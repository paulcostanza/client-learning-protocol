...
*Side note*, \`let\` and \`const\` would throw a \`ReferenceError\` because when they are hoisted they exist in the *Temporal Dead Zone*. Oh JavaScript...`},{id:5,type:"radio",category:"javascript",subcategory:"",title:"",question:"Which function is used to serialize an object into a JSON string?",options:["stringify()","parse()","convert()"],random:!0,answer:"stringify()"},{id:6,type:"radio",category:"javascript",subcategory:"weird-js",title:"Undefined is...",question:`What will this code output:
~~~javascript
