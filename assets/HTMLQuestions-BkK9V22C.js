...
~~~ 
`},{id:58,type:"checkbox",category:"html",subcategory:"forms",title:"Incorrect button types",question:"Which of the following button examples does NOT use a correct value for the `type` attribute?",options:['`<button type="button">Press Button</button>`','`<button type="submit">Submit</button>`','`<button type="btn">Press Button</button>`','`<button type="reset">Reset</button>`','`<button type="rst">Reset</button>`','`<button type="press">Press</button>`','`<button type="select">Select</button>`','`<button type="apply">Apply</button>`','`<button type="clear">Clear</button>`'],random:!0,answer:['`<button type="btn">Press Button</button>`','`<button type="rst">Reset</button>`','`<button type="press">Press</button>`','`<button type="select">Select</button>`','`<button type="apply">Apply</button>`','`<button type="clear">Clear</button>`']}];export{e as default};
