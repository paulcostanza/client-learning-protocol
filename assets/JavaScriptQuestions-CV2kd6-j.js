...
result += str8.concat(str1, space, str3)
// "?" + "HelloHow" + " HelloHow" + "!"
~~~`},{id:22,type:"radio",category:"javascript",subcategory:"intro-to-node-js",title:"",question:"What is the primary reason for using `nvm`?",options:["to install `npm` packages globally","to execute Node.js scripts in the browser","to manage and switch between multiple Node.js versions","to debug Node.js applications efficiently"],random:!0,answer:"to manage and switch between multiple Node.js versions",description:""},{id:23,type:"input",category:"javascript",subcategory:"intro-to-node-js",title:"",question:"What `nvm` command would you use to switch the current terminal session to Node.js version `18.17.1`?",options:[""],random:!1,answer:"^\\s*nvm use 18.17.1\\s*$",description:"Answer: `nvm use 18.17.1`"},{id:24,type:"input",category:"javascript",subcategory:"intro-to-node-js",title:"",question:"How would I run the JavaScript file called `index` using Node.js?",options:[""],random:!1,answer:"^\\s*node index.js\\s*$",description:"Answer: `node index.js`"},{id:25,type:"input",category:"javascript",subcategory:"intro-to-node-js",title:"",question:"What command initializes a new Node.js project and creates a `package.json` file?",options:[""],random:!1,answer:"^\\s*npm init\\s*$",description:"Answer: `npm init`"},{id:26,type:"radio",category:"javascript",subcategory:"intro-to-node-js",title:"",question:"What is the purpose of the `package.json` file created by `npm init`?",options:["defines the HTML structure of the applications","configures the web server settings","tracks the project's details and dependencies","stores environment variables for the application"],random:!0,answer:"tracks the project's details and dependencies",description:""},{id:27,type:"checkbox",category:"javascript",subcategory:"authentication",title:"",question:"What properties belong to authentication and authorization?",options:["authentication verifies identity","authorization grants permissions","authorization verifies identity","authentication grants permissions"],random:!0,answer:["authentication verifies identity","authorization grants permissions"]},{id:28,type:"radio",category:"javascript",subcategory:"authentication",title:"",question:"Why must authentication always happen before authorization in a backend system?",options:["authorization verifies identity, so it cannot work without authentication first","both processes run simultaneously, so order does not matter at all","authentication requires permission checks before identity can be confirmed","you cannot decide what permissions to grant until you know who the user is."],random:!0,answer:"you cannot decide what permissions to grant until you know who the user is.",description:""},{id:29,type:"radio",category:"javascript",subcategory:"authentication",title:"",question:"What security purpose does the signature part of a JWT serve?",options:["it encrypts the entire token so nobody can read the user data","it stores the user's password in a hashed format for later verification","it allows the server to remember all active sessions in its memory","it prevents tampering by making the token invalid if the payload changes"],random:!0,answer:"it prevents tampering by making the token invalid if the payload changes",description:""},{id:30,type:"radio",category:"javascript",subcategory:"authentication",title:"",question:"Why should you never store sensitive data like passwords or credit card numbers inside a JWT?",options:["decrypting the encrypted payload is slow","the payload is Base64 encoded","the payload gets erased every time the user logs out automatically","the payload can only hold numbers, not letters or special characters"],random:!0,answer:"the payload is Base64 encoded",description:"The payload is Base64 encoded, meaning anyone can decode and read it."},{id:31,type:"checkbox",category:"javascript",subcategory:"authentication",title:"",question:"What are the three distinct parts that make up a JSON Web Token?",options:["header","body","footer","metadata","claims","hash","payload","signature","secret key","data"],random:!0,answer:["header","payload","signature"]},{id:32,type:"radio",category:"javascript",subcategory:"authentication",title:"",question:"How does a CSRF token prevent a malicious website from forging a valid request? The token...",options:["is stored in the user session","is hashed together with the user password for extra security","expires every five seconds","replaces the session cookie entirely on every single request"],random:!0,answer:"is stored in the user session",description:"Since the token is stored in the user session the malicious site cannot copy it because it does not have access to the user's front-end."},{id:33,type:"radio",category:"javascript",subcategory:"authentication",title:"",question:"What is the core vulnerability that enables a CSRF attack?",options:["the server stores passwords in plain text instead of a hashed format","the browser automatically attaches cookies to any request going to the target server","the user refuses to log out of websites after completing their session","the backend encrypts all session data with a weak algorithm"],random:!0,answer:"the browser automatically attaches cookies to any request going to the target server",description:""},{id:34,type:"radio",category:"javascript",subcategory:"authentication",title:"",question:"How does the `SameSite=Lax` cookie attribute help defend agains CSRF attacks? It...",options:["blocks all cookies completely, requiring token-based authentication only","allows cookies only when the user safely navigates, blocking cross-site form submissions","encrypts the cookie value so malicious sites cannot forge the request","sends cookies only to the same domain but allows all third-party scripts"],random:!0,answer:"allows cookies only when the user safely navigates, blocking cross-site form submissions",description:""}];export{e as default};
