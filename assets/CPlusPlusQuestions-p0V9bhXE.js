...
delete ptr;
~~~
`,options:["nope, good to go","memory leak","undefined behavior","stack overflow"],random:!0,answer:"undefined behavior",description:"Answer: undefined behavior due to wrong delete\n\n`new int[5]` allocates an array, so you must use `delete[] ptr;`. Using just `delete` is for single objects. Using the wrong one can corrupt memory, leading to undefined behavior.\n\n- `new` allocation -> `delete` deallocation\n- `new[]` allocation -> `delete[]` deallocation\n"},{id:17,type:"checkbox",category:"c++",subcategory:"",title:"Storage duration",question:"What are the four categories of storage duration?",options:["dynamic","thread","static","automatic","BSS","local","global","protected"],random:!0,answer:["dynamic","thread","static","automatic"],description:"- *dynamic storage duration* is explicitly allocated and deallocated by the programmer using dynamic memory management functions (`new` and `delete`)\n- *thread storage duration* is allocated when the thread in which it is created begins and deallocated when the thread ends\n- *static storage duration* is allocated when the program begins (before `main()` is executed) and deallocated only when the program ends, with only one instance of the object throughout the entire program's execution\n- *automatic storage duration* is allocated when its enclosing code block is entered and deallocated when that block is exited, the default for most local variables and function parameters that are typically managed using the stack"},{id:18,type:"radio",category:"c++",subcategory:"storage",title:"Local duration?",question:"Which storage duration is the default for local variables inside a function?",options:["static","dynamic","automatic","thread"],random:!0,answer:"automatic",description:""},{id:19,type:"radio",category:"c++",subcategory:"storage",title:"Static storage?",question:"When is memory for an object with static storage duration allocated?",options:["when the function is called","when the variable is first used","before `main()` begins","when `new` is called"],random:!0,answer:"before `main()` begins",description:""},{id:20,type:"radio",category:"c++",subcategory:"storage",title:"Static storage?",question:"Which of the following statements about automatic storage duration is true?",options:["it always uses heap memory","it is guaranteed to use stack memory","it is tied to block scope lifetime","it must be manually deallocated"],random:!0,answer:"it is tied to block scope lifetime",description:""},{id:21,type:"radio",category:"c++",subcategory:"storage",title:"Storage duration",question:`What is the storage duration of the following variables?
...
~~~
`,options:["automatic","static","dynamic","thread"],random:!0,answer:"static",description:"Even though it is inside a function, `static` gives it a static storage duration."},{id:22,type:"radio",category:"c++",subcategory:"storage",title:"Thead local",question:"What is true about variables declared with `thread_local`?",options:["they are shared across all threads","they exist only during function execution","each thread has its own instance","they must be manually deleted"],random:!0,answer:"each thread has its own instance",description:""},{id:23,type:"radio",category:"c++",subcategory:"storage",title:"Extern",question:"What does the `extern` keyword do?",options:["gives a variable static storage duration","allocates memory globally","declares a variable defined elsewhere","forces heap allocation"],random:!0,answer:"declares a variable defined elsewhere",description:""},{id:24,type:"radio",category:"c++",subcategory:"storage",title:"Easy",question:`What is the storage duration of \`x\`?
~~~c++
int* x = new int(5);
~~~
`,options:["automatic","static","dynamic","thread"],random:!0,answer:"automatic",description:"Certainly not an easy one... `x` (the pointer itself) is a local variable, which means automatic storage. However, the memory it points to (`new int(5)`) means dynamic storage.\n        \nWhen it comes to storage duration, the variable *does not equal* what it points to."},{id:25,type:"radio",category:"c++",subcategory:"exception-safety",title:"",question:"Which of the following best describes the strong exception safey guarantee?",options:["the operation never throws an exception","the operation may fail, but no resources are leaked and the program remains in a valid state","the operation either completes successfully or has no effect on the program state","no guarantees are made if an exception occurs"],random:!0,answer:"the operation either completes successfully or has no effect on the program state",description:""},{id:26,type:"radio",category:"c++",subcategory:"development-examples",title:"",question:"What is the first thing the compiler does with a source file?",options:["creates object files","runs the linker","preprocesses preprocessor statements","creates an executable"],random:!0,answer:"preprocesses preprocessor statements",description:""},{id:27,type:"radio",category:"c++",subcategory:"development-examples",title:"",question:"What does `#include <iostream>` do?",options:["compiles the `iostream` library","copies the contents of iostream into current file","creates an executable","links `iostream` to the program after `cpp` files are compiled to `obj` files"],random:!0,answer:"copies the contents of iostream into current file",description:""},{id:28,type:"radio",category:"c++",subcategory:"development-examples",title:"Link this",question:"What is the job of the linker",options:["combine `obj` files together","combine `cpp` files together","combine `exe` files together","execute the program","convert C++ into machine code","run the preprocessor"],random:!0,answer:"combine `obj` files together",description:""}];export{e as default};
