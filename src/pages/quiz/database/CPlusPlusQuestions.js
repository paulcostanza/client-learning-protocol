export default [
    {
        ...
        title: 'Compiler produces...',
        question: "What does the compiler produce after translating C++ source code?",
        options: [
            'executable file',
            'object file',
            'source code',
...
3. Linking: combines object files and libraries, resolves all references, and produces the final executable.`
    },
    {
        ...
        subcategory: 'development-compiler-linker-libraries',
        title: 'Cannot linker',
        question: "What happens if the linker cannot resolve a reference between object files?",
        options: [
            'the program runs with warnings',
            'the linker generates an error and aborts',
        ...
        random: true,
        answer: 'the linker generates an error and aborts',
        description: ``
    },
    {
        id: 3,
        ...
        title: 'C++ > C',
        question: "What is the most notable innovation of C++ over C?",
        options: [
            'garbage collection',
