...
const starterCode = `def find_max_in_nested_list(nums: list) -> int:
...
const testCode = `def run_tests():
    ...
    for i, (nums, expected) in enumerate(test_cases, 1):
        try:
            result = find_max_in_nested_list(nums)
...
export const findMaxInNestedList = {
    id: "find-max-in-nested-list",
    title: "64. Find Max In Nested List",
    problemStatement: `<p>Return the max integer in a nested list, regardless of depth.</p>`,
    starterCode,
    testCode,
    constraints,
    example,
    status: getProblemStatusById("find-max-in-nested-list"),
    solution: solution
}
