export const problemsList = {
    ...
    sets: [
        ...
        { id: "count-unique-words", title: "Count Unique Words", status: '', review: '', order: 25 },
        { id: "contains-duplicate", title: "Contains Duplicate", status: '', review: '', order: 26 },
    ],
    dictionaries: [
        { id: "get-dictionary-keys", title: "Get Dictionary Keys", status: '', review: '', order: 27 },
        { id: "get-dictionary-values", title: "Get Dictionary Values", status: '', review: '', order: 28 },
        { id: "count-characters", title: "Count Characters", status: '', review: '', order: 29 },
