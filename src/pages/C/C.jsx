        ...
        <>
            ...
            <main>
                <div className="container" id="space-on-top-of-page">
                    ...
                    <blockquote>
                        Even though we will be using C, this course is focused on memory management
                    </blockquote>
                    ...
                    <ul>
                        ...
                        <li>the opening bracket, <code>(insert left curly brace)</code> is the start of the function body</li>
                        ...
                        <li>the closing bracket, <code>(insert right curly brace)</code> denotes the end of the function's body</li>
                    </ul>
                    ...
                    <p>But in C, it would crash <em>before</em> it can even run. If there is a problem, the compiler tells us before the program even starts. Now...C does not tell us about all the possible problems that might arise in our program. But it does tell us about some of them.</p>
                    <p>The compiler checks your source code, turns the source code into an executable, and then directly run the executable wherever it is to run.</p>
                    ...
                    <pre><code>char *msg_from_dax = "You still have 0 users";</code></pre>
                    ...
                    <p>Example:</p>
                    <pre><code>printf("Hello, %s. You are %d years old. \n", name, age);</code></pre>
                    ...
                    <ul>
                        ...
                        <li>The <code>sizeof</code> operator always returns a value of type size_t</li>
