        ...
        <>
            ...
            <main>
                <div className="container" id="space-on-top-of-page">
                    ...
                    <pre className="hljs"><code><div>speed = <span className="hljs-number">5</span>
                    ...
                    <pre className="hljs"><code><div><span className="hljs-function"><span className="hljs-keyword">def</span> <span className="hljs-title">main</span><span className="hljs-params">()</span>:</span>
                        health = <span className="hljs-number">10</span>
                        armor = <span className="hljs-number">5</span>
                        add_armor(health, armor)

                        <span className="hljs-function"><span className="hljs-keyword">def</span> <span className="hljs-title">add_armor</span><span className="hljs-params">(h, a)</span>:</span>
                        new_health = h + a
                        print_health(new_health)

                        <span className="hljs-function"><span className="hljs-keyword">def</span> <span className="hljs-title">print_health</span><span className="hljs-params">(new_health)</span>:</span>
                        print(<span className="hljs-string">f"The player now has <span className="hljs-subst">{"{new_health}"}</span> health"</span>)

                        <span className="hljs-comment"># call entrypoint last</span>
                        main()
                    </div></code></pre>
                    ...
                    <hr />
                    <p>_____ are the inputs specified by the funciton definition.</p>
                    <ul>
                        <li>parameters</li>
                    </ul>
                    <hr />
